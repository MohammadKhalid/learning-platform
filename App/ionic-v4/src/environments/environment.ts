...
export const SERVER_URL = 'http://192.168.0.138:3000/v1/';
export const SOCKET_URL = 'http://192.168.0.138:3000/';
export const RTC_SIGNALLING_SERVER_URL = 'https://thrive19.com:9001/';
export const IMAGE_URL = 'http://192.168.0.138:3000/v1/uploads';
