...
const getAll = async function(req, res){
    ...
    let userCompanies;
    [err, userCompanies] = await to(loggedUser.getCompanies());
    ...
    let userModel = User.scope({ method: [loggedUser.type + 'Users', userCompaniesIds]});
    [err, items] = await to(userModel.findAll(qParams));
